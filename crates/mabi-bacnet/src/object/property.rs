...
impl PropertyId {
    ...
    pub fn from_u32(value: u32) -> Option<Self> {
        ...
        match value {
            ...
            // Schedule / trend log / historical data properties
            123 => Some(Self::WeeklySchedule),
            124 => Some(Self::AttemptedSamples),
            125 => Some(Self::AverageValue),
            126 => Some(Self::BufferSize),
            127 => Some(Self::ClientCovIncrement),
            128 => Some(Self::CovResubscriptionInterval),
            131 => Some(Self::LogBuffer),
            132 => Some(Self::LogDeviceObjectProperty),
            133 => Some(Self::Enable),
            134 => Some(Self::LogInterval),
            135 => Some(Self::MaximumValue),
            136 => Some(Self::MinimumValue),
            137 => Some(Self::NotificationThreshold),
            138 => Some(Self::PreviousNotifyRecord),
            140 => Some(Self::RecordsSinceNotification),
            141 => Some(Self::RecordCount),
            142 => Some(Self::StartTime),
            143 => Some(Self::StopTime),
            144 => Some(Self::StopWhenFull),
            145 => Some(Self::TotalRecordCount),
            146 => Some(Self::ValidSamples),
            147 => Some(Self::WindowInterval),
            148 => Some(Self::WindowSamples),
            149 => Some(Self::MaximumValueTimestamp),
            150 => Some(Self::MinimumValueTimestamp),
            151 => Some(Self::VarianceValue),
            _ => None,
        }
    }
